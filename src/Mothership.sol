...
contract Mothership {
    ...
    function _isFleetMember(SpaceShip spaceship)
        private
        view
        returns (bool isFleetMember)
    {
...
contract SpaceShip {
    ...
    function _isCrewMember(address member)
        private
        view
        returns (bool isCrewMember)
    {
...
contract RefuelModule {
    ...
    function addAlternativeRefuelStationsCodes(uint256 refuelStationCode)
        external
    {
